...
#+end_src
* Global packages
This section is about configuring global emacs helpers which are not specific to a dedicated language (or filetype)
but are useful for any edition use-case in emacs.
** Global
#+BEGIN_SRC emacs-lisp
